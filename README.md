...
## 🎬 Demo
> Replace this line with your demo video link once recorded, and add a screenshot/GIF below.
<!-- ![CivicLens demo](docs/demo.gif) -->
...
cp .env.example .env   # set GEMINI_API_KEY (server) and GOOGLE_MAPS_PLATFORM_KEY; Firebase config is bundled
npm run dev
```
