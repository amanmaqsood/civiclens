    ...
    <form onSubmit={onSubmit} className="mx-auto flex w-full max-w-3xl flex-col gap-5 px-4 py-5 font-sans pb-28 text-ink sm:px-6 lg:py-8">
      <div className="bg-alert/5 border border-alert/20 p-4 rounded-xl flex flex-col gap-2">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-xl font-display font-bold text-alert">Manual logging mode active</p>
        </div>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="fallback-category" className="text-sm font-mono text-slate block">Report category</label>
        <select
      ...
      <div className="flex flex-col gap-1.5 bg-paper border border-hairline p-3 rounded-xl">
        <div className="flex items-center justify-between text-sm font-mono">
          <label htmlFor="fallback-severity" className="text-slate block cursor-pointer">Severity rating scale</label>
      ...
      {/* Address */}
      <div className="flex flex-col gap-1.5">
        <span className="text-sm font-mono text-slate block">Identified location reference</span>
      ...
      {/* Descriptions */}
      <div className="flex flex-col gap-1.5">
        <label htmlFor="fallback-description" className="text-sm font-mono text-slate block">Report description</label>
        <textarea
